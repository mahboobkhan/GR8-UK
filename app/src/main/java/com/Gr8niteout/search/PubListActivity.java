...
import static com.Gr8niteout.R.id.imgPlaceHolder;
import static com.Gr8niteout.R.id.ratingBar1;
import static com.Gr8niteout.R.id.txtMiles;
import static com.Gr8niteout.R.id.txtPrice;
import static com.Gr8niteout.R.id.txtPubName;
import static com.Gr8niteout.R.id.txtStatus;
...
public class PubListActivity extends AppCompatActivity {
    ...
    ArrayList<PubModel.response.find_pub.find_pubs_lists> list = new ArrayList<>();
...
//    @BindView(R.id.txtTitle)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listPubs =  findViewById(R.id.listPubs);
        ...
        CommonUtilities.setFontFamily(PubListActivity.this,txtempty, CommonUtilities.AvenirLTStd_Medium);
        ...
        listPubs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(PubListActivity.this, PubActivity.class);
    ...
    public void setFont()
    {
        CommonUtilities.setFontFamily(PubListActivity.this,txtTitle,CommonUtilities.Avenir);
    }
    ...
    public void getPubs(int page, boolean flag, String key,String data) {
        ...
        ServerAccess.getResponse(PubListActivity.this,key, params, flag, new ServerAccess.VolleyCallback() {
            @Override
    ...
    class PubListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                LayoutInflater inflater = (PubListActivity.this).getLayoutInflater();
                ...
                CommonUtilities.setFontFamily(PubListActivity.this, holder.txtPubName,CommonUtilities.AvenirNextLTPro_Regular);
                CommonUtilities.setFontFamily(PubListActivity.this, holder.txtPrice,CommonUtilities.AvenirNextLTPro_Regular);
                CommonUtilities.setFontFamily(PubListActivity.this, holder.txtMiles,CommonUtilities.AvenirNextLTPro_Regular);
                CommonUtilities.setFontFamily(PubListActivity.this, holder.txtStatus,CommonUtilities.AvenirNextLTPro_Regular);
                view.setTag(holder);
            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            if (txtempty.getVisibility() != View.VISIBLE) {
                Intent intent = new Intent(PubListActivity.this, FilterActivity.class);
