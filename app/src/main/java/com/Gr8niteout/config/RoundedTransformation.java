...
/**
 * Created by dixit on 2/3/2017.
 */

public class RoundedTransformation implements Transformation<Bitmap> {
    ...
    public RoundedTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundedTransformation(BitmapPool pool, int radius, int margin) {
